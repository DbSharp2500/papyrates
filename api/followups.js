// api/followups.js
// Follow-up questions on a finished report - ADMIN tier only (the Research Assistant does not get follow-ups: they ask,
// read the report, and tell the owner if something matters).
//
